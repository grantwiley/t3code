...
const runPiCommand = (args: ReadonlyArray<string>) => runCommand("pi", args);
...
export const ProviderHealthLive = Layer.effect(
  ProviderHealth,
  Effect.gen(function* () {
    const statusesFiber = yield* Effect.all([checkCodexProviderStatus, checkPiProviderStatus]).pipe(
      Effect.forkScoped,
    );
